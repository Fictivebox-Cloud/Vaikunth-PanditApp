class ImageConst {
  ...
  final ARROW = "assets/images/arow.png";
  final profile = "assets/images/profilea.svg";
  final AADHARBACK = "assets/image/Aadhar Back.png";
  final AADHARFRONT = "assets/image/Aadhar Front.png";
  final BANK = "assets/images/bank.png";
  final BOOKING = "assets/images/booking.png";
  final CAMERA = "assets/image/Camera.png";
  final CEMETERY = "assets/image/emetery.png";
  final EARNING = "assets/images/earning.png";
  final SETTING = "assets/images/settings.png";
