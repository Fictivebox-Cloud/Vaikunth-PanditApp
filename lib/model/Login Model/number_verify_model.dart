...
NumberVerifyModel numberVerifyModelFromJson(String str) => NumberVerifyModel.fromJson(json.decode(str));

String numberVerifyModelToJson(NumberVerifyModel data) => json.encode(data.toJson());
...
class NumberVerifyModel {
  ...
  factory NumberVerifyModel.fromJson(Map<String, dynamic> json) => NumberVerifyModel(
...
class PanditDetails {
  ...
  factory PanditDetails.fromJson(Map<String, dynamic> json) => PanditDetails(
    ...
    panditServices: json["pandit_services"] == null ? null : json["pandit_services"],
