...
class City_Screen extends StatefulWidget {
  final String? name3,photo3;

  const City_Screen({Key? key,this.name3,this.photo3}) : super(key: key);
                          ...
                          Container(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemBuilder: ((context, index) {
                                    return Text(data.cityMidel.response!
                    ...
                    child: TextButton(
                        ...
                        onPressed: () {
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context) =>
                                  Documents_Screen(name: widget.name3,
                                    photo: widget.photo3,)));
