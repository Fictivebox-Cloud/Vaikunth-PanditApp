...
const String VIEWYOURVAIKUNTHIDCARD = "View your Vaikunth ID card";
const String WELCOMETOBAIKHUBTPANDIT = "Welcome to Vaikhunt Pandit";
...
const String ENTERYOURPHONENUMBER = "Enter Your Phone Number";
...
const String ADDREMOVESERVICES = "Add/Remove services";
...
const String ENTER_YOUR_AADHAR_NO = "Enter Your Aadhar No";
...
const String ACCESS_APP_SETTING_HERE = "Access app settings here";
const String LOGOUT = "Logout";
const String LOGOUTFROMTHEAPP = "Logout from the app";
const String CANCEL = "Cancel";
const String PRIVACYPOLICY = "Privacy Policy";
const String TERMS_CONDITIONS = "Terms & Conditions";
const String HELPSUPPORT = "Help & Support";
const String IDCARD = "ID Card";
