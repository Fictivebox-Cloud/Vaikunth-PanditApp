...
class Check_Booking_Confirm_OTP_View_Model with ChangeNotifier{
  ...
  CheckBookingConfirmOtpModel? get getcheckBookingConfirmOtpModel => _bookingConfirmOtpModel;
  ...
  setGetCheckBookingConfirmOtpModel(CheckBookingConfirmOtpModel checkBookingConfirmOtpModel){
...
var response = await ApiRemoteServices.fechingGetApi(apiUrl: GET_CHECK_BOOKING_OTP,apiData: data);
