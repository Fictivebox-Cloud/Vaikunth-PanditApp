    ...
    return Column(
      children: [
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
             personaldetailviewmodel?.presonalDetailModel?.response?.panditbanklist?.first.panNo.toString() ?? "",
                    style: GoogleFonts.lato(fontSize: 14,fontWeight: FontWeight.w500),),
                ],),
              const Spacer(),
              Text(EDIT,style: GoogleFonts.lato(fontSize: 12,fontWeight: FontWeight.w500,color:EDITCOLOR),),
        ...
        Align(
            ...
            child: Text(personaldetailviewmodel?.presonalDetailModel?.response?.panditDetails?.cityname ?? "", style: GoogleFonts.lato(fontSize: 16,fontWeight: FontWeight.w400),)),
