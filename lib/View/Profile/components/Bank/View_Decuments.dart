...
class View_Decuments extends StatelessWidget {
  ...
  return Column(
        children: [
          Image.network(provider.presonalDetailModel!.response!.panditIDcard![0].aadharFront.toString()),
          Spacer()
          ,Image.network(provider.presonalDetailModel!.response!.panditIDcard![0].aadharBack.toString())
        ],
      );
  },
)
