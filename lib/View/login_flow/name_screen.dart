...
class _NameScreenState extends State<NameScreen> {
  ...
  return Align(
      ...
      style: ButtonStyle(
        ...
        elevation: MaterialStateProperty.resolveWith((states) => provider.isNotNull ? 5.0 : 0.0),
        ...
        backgroundColor:
        MaterialStateColor.resolveWith((states) => provider.isNotNull ? colorPrimary : white),
      ),
      onPressed: () {
        provider.isNotNull ? Navigator.push(
              context,
              MaterialPageRoute(
